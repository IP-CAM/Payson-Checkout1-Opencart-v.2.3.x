		...
		$data['button_cancel'] = $this->language->get('button_cancel');
 		...
 		if (isset($this->error['warning'])) {
   		...
   		$data['breadcrumbs'][] = array(
                    ...
                    'href'      => $this->url->link('common/dashboard', 'token=' . $this->session->data['token'] . '&type=total', true),      		
   		);
   		...
   		$data['breadcrumbs'][] = array(
                    ...
                    'href'      => $this->url->link('extension/total/paysoninvoice_fee', 'token=' . $this->session->data['token'] . '&type=total', true),
   		);
		
		$data['action'] = $this->url->link('extension/total/paysoninvoice_fee', 'token=' . $this->session->data['token'] . '&type=total', true);
